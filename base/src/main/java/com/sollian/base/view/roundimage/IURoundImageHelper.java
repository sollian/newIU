...
public class IURoundImageHelper {
    ...
    public static final int DEFAULT_CORNER_R5   = IUUtil
            .dp2px(BaseContext.Companion.getContext(), 32);
    public static final int DEFAULT_CORNER_R2   = IUUtil
            .dp2px(BaseContext.Companion.getContext(), 32);
    ...
    private void calculateRadius() {
        if (cornerRadius == DEFAULT_CORNER_R5 || cornerRadius == DEFAULT_CORNER_R2) {
            cornerRadius = vImage.getWidth() > IUUtil.dp2px(vImage.getContext(), 32)
                           ? DEFAULT_CORNER_R5 : DEFAULT_CORNER_R2;
        }
    }
    ...
    private Matrix getImageMatrix() {
        if (OsVersionUtil.hasJellyBeanMR2()) {
            return vImage.getImageMatrix();
        } else {
            try {
                return (Matrix) Reflector.getFieldSafe(ImageView.class, "mDrawMatrix", vImage);
