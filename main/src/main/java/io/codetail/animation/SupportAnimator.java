...
public abstract class SupportAnimator {
    ...
    /**
     * @return true if using native android animation framework, otherwise is nineoldandroids
     */
    public abstract boolean isNativeAnimator();

    /**
     * @return depends from {@link android.os.Build.VERSION} if sdk version {@link
     * android.os.Build.VERSION_CODES#LOLLIPOP} and greater will return {@link
     * android.animation.Animator} otherwise {@link com.nineoldandroids.animation.Animator}
     */
    public abstract Object get();

    /**
     * Starts this animation. If the animation has a nonzero startDelay, the animation will start
     * running after that delay elapses. A non-delayed animation will have its initial value(s) set
     * immediately, followed by calls to {@link android.animation.Animator.AnimatorListener#onAnimationStart(android.animation.Animator)}
     ...
     * hierarchy, then the calling thread should be the UI thread for that view hierarchy.</p>
     */
